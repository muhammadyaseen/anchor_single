...
#define TAG_POLL_F_MSG_LEN                    1				// FunctionCode(1), +extra code
#define ANCH_RESPONSE_F_MSG_LEN               2               // FunctionCode(1),
...
#define PCODE                               FCODE+1         // password is the byte after function code
...
// PASSWORDS
#define POLL_KEY_LEN						4
//#define POLL_PASS_CODE						"64BITPAS"
//#define POLL_WRNG_CODE						"32BITPAS"

#define RESP_PASS_CODE						0x55
#define RESP_WRNG_CODE						0x54
...
{
    TA_INIT, //0
	TA_TXREQ_BLINK_SEND,         // in this state ANCHOR requests TAG to send a BLINK (REQ is essentially a BLINK signal)
    TA_TXE_WAIT,                //1
...
typedef struct{
	...
	uint8 	key_index	; 	// 	index of the data
	uint8 	key[4]	;	//	generated key
